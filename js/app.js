 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            ...
            if (document.querySelector(".close-menu")) document.addEventListener("click", (function(e) {
        ...
        const inputMasks = document.querySelectorAll(".input-tel");
        ...
        function rangeInit() {
            const rangeItems = document.querySelectorAll(".form-credit__range");
            if (rangeItems.length) rangeItems.forEach((slider => {
                let textFrom = Number(slider.getAttribute("data-from"));
                let textTo = Number(slider.getAttribute("data-to"));
                initialize(slider, {
                    start: 0,
                    connect: [ true, false ],
                    range: {
                ...
                const inputWrap = slider.closest(".form-credit__item");
                const input = inputWrap.querySelector("input");
                slider.noUiSlider.on("update", (function(values, handle) {
                    if (!slider.classList.contains("form-credit__range_percent")) input.value = Math.round(values[handle]); else input.value = values[handle];
                    const sum = document.querySelector(".form-credit__input_sum input");
                    const time = document.querySelector(".form-credit__input_time input");
                    const percent = document.querySelector(".form-credit__input_percent  input");
                    let interestRate = percent.value / 100;
                    let loanTerm = time.value;
                    let loanAmount = sum.value;
                    const totalSpan = document.querySelector(".form-credit__total span");
                    let monthlyPayment = loanAmount * (interestRate / 12) * Math.pow(1 + interestRate / 12, loanTerm * 12) / (Math.pow(1 + interestRate / 12, loanTerm * 12) - 1);
                    totalSpan.textContent = Math.round(monthlyPayment);
                }));
        ...
        function initSliders() {
            if (document.querySelector(".main-section__slider")) new swiper_core_Swiper(".main-section__slider", {
                ...
                navigation: {
                    prevEl: ".main-section__arr_prev",
                    nextEl: ".main-section__arr_next"
                },
                on: {}
            });
            if (document.querySelector(".certificates__slider")) new swiper_core_Swiper(".certificates__slider", {
                ...
                pagination: {
                    el: ".certificates .pagination-slider",
                    clickable: true
                },
                navigation: {
                    prevEl: ".certificates .certificates__arr_prev",
                    nextEl: ".certificates .certificates__arr_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".partners__slider")) new swiper_core_Swiper(".partners__slider", {
                ...
                navigation: {
                    prevEl: ".partners .certificates__arr_prev",
                    nextEl: ".partners .certificates__arr_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 2,
            ...
            if (document.querySelector(".reviews__slider")) new swiper_core_Swiper(".reviews__slider", {
                ...
                pagination: {
                    el: ".reviews .pagination-slider",
                    clickable: true
                },
                navigation: {
                    prevEl: ".reviews .certificates__arr_prev",
                    nextEl: ".reviews .certificates__arr_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
...
***************************************************************************** */
        ...
        da.init();
        const searchHeaderPc = document.querySelector(".bottom-header__search.search");
        document.addEventListener("click", (function(e) {
            if (e.target.closest(".open-search")) if (!searchHeaderPc.classList.contains("_active")) searchHeaderPc.classList.add("_active"); else searchHeaderPc.classList.remove("_active"); else if (searchHeaderPc.classList.contains("_active") && !e.target.closest(".bottom-header__search.search")) searchHeaderPc.classList.remove("_active");
        }));
        const chkConsult = document.querySelectorAll(".privacy input");
        if (chkConsult.length > 0) chkConsult.forEach((chk => {
            chk.addEventListener("change", (function(e) {
                chk.closest("label").classList.toggle("_checked");
            }));
        }));
        window["FLS"] = true;
        isWebp();
